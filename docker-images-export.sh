...
alpine_git_images=("alpine/git:2.43.0" "alpine/git:v2.43.0" "alpine/git:latest")
alpine_openssl_images=("alpine/openssl:3.1.4" "alpine/openssl:latest")
...
pull_and_save alpine_git_images "alpine-git-images"
pull_and_save alpine_openssl_images "alpine-openssl-images"
